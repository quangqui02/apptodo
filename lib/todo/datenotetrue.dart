...
class DateNoteT extends StatefulWidget {
  DateNoteT({Key? key, required this.timenote, required this.cate})
      : super(key: key);
  String? timenote;
  String? cate;
  @override
      ...
      body: SafeArea(
        child: StreamBuilder<List<Todo>>(
            stream: this.widget.cate == 'Tất Cả'
                ? TodoProvider().listtododatenotT(this.widget.timenote)
                : TodoProvider()
                    .listtododatecateT(this.widget.timenote, this.widget.cate),
